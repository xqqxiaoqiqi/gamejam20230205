...
namespace Yade.Runtime
{
    ...
    public class YadeSheetData : ScriptableObject
    {
        ...
        internal void AddRow(int baseRowIndex)
        {
            if (this.data == null)
            {
                this.data = new Rows();
            ...
            this.data.items.MoveBy(baseRowIndex, 1);
        }
        ...
        internal void AddColumn(int baseColumnIndex)
        {
            if (this.data == null)
            {
                this.data = new Rows();
            ...
            {
                var row = this.data.items[key];
                row.cells.MoveBy(baseColumnIndex, 1);
            }
            ...
            columnHeaders.items.MoveBy(baseColumnIndex, 1);
        }
